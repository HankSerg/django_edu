...
class CourseUpdateView(PermissionRequiredMixin,
                        OwnerCourseEditMixin,
                        UpdateView):
    """ позволяем владельцу редактировать курс """
...
class ContentCreateUpdateView(TemplateResponseMixin, View):
    """
    get_model() возвращает класс модели
    get_form() создает форму
    dispatch() получает данные из запроса и создает объекты модуля
